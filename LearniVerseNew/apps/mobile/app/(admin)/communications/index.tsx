...
export default function CommunicationsAdminScreen() {
  return <PlaceholderScreen title="Communications" icon="megaphone-outline" description="School-wide announcements and messaging will be available in the upcoming mobile release. Please use the web portal for now." />;
}
