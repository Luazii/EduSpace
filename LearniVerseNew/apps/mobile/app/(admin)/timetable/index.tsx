...
export default function TimetableAdminScreen() {
  return <PlaceholderScreen title="Timetable" icon="calendar-outline" description="Class schedule and timetable management will be available in the upcoming mobile release. Please use the web portal for now." />;
}
