...
export default function FeesAdminScreen() {
  return <PlaceholderScreen title="Fee Office" icon="card-outline" description="Fee management and invoicing will be available in the upcoming mobile release. Please use the web portal for now." />;
}
